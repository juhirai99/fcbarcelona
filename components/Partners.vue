<template>
  <v-row class="partners">
    <v-col cols="12" sm="12" md="12" class="text_center">
      <span class="partnersHeader">Main Partners</span>
      <a href="https://www.nike.com/gb/en_gb/c/fcbarcelona" class="icon_anchor">
        <svg
          class="marketing-partners__logo marketing-partners__logo--nike"
          viewBox="0 0 200 71.98"
        >
          <path
            fill="#fff"
            d="M0 51.6c0 5.32 1.65 10 5.74 13.51A27.82 27.82 0 0024.52 72c9.41 0 18.76-3.78 26.08-6.71C62.92 60.34 199.16 1.18 199.16 1.18c1.31-.66 1.06-1.48-.58-1.07L50.27 40.29a32.78 32.78 0 01-8.6 1.23c-11.34.07-21.44-6.23-21.36-19.52 0-5.19 1.63-11.45 5.31-18.82C12.61 18.48.13 37.43 0 51.6z"
          ></path>
        </svg>
      </a>
      <a
