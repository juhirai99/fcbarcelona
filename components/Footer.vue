<template>
  <v-row class="min_footer"> 
    <v-col cols="12" class="social-accounts__title text_center">
      <span>Follow FC Barcelona on social media</span>
    </v-col>
    <v-col cols="12" sm="6" md="12">
      <v-row class="div_center">
        <v-col
          cols="6"
          sm="6"
          md="1"
        ...
        >
          ...
          >
            ...
            <p class="font_style">{{ social.title }}</p>

            <p class="font_style">{{ social.channel }}</p>
          </v-card>
        </v-col>
      </v-row>
    </v-col>
      ...
      <div class="footer__sitemap">
        <nav class="footer-sitemap" role="navigation">
          <div class="footer-sitemap__group">
            <h4 class="footer-sitemap__nav-title">{{footer.header}}</h4>
            <ul class="footer-sitemap__nav-list" v-for="footerList in footer.link">
              <li class="footer-sitemap__nav-item">
                <a  class="footer-sitemap__nav-link" >{{footerList}}</a
                >
              </li>
            </ul>
          </div>
    ...
    <v-col cols="12" class="ml_10">
      <svg class="icon logodesign" viewBox="0 0 515.16 80.36">
        <path
    ...
    <v-col cols="6" class="ml_10">
      <span>© Copyright FC Barcelona</span>
      <span class="official_font">
        Official website of FC Barcelona
      </span>
    </v-col>
    <v-col>
      <a class="link_color">Legal Terms</a> |
      <a class="link_color">Privacy Policy</a> |<a class="link_color"
        >Cookies</a
      >
      |<a class="link_color">Accessibility</a> |
      <a class="link_color">Contact Us</a> |
      <a class="link_color">Support/FAQs</a>
    </v-col>
  </v-row>
</template>
